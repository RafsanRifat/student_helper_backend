...
from .views import api_endpoints, TeacherSignupView, StudentSignupView, TeacherList, StudentList, UserLogoutView, UserDetailView
...
urlpatterns = [
    ...
    path('api/user/<int:id>', UserDetailView.as_view(), name='teacher'),
